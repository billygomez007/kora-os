...
@Module({
  ...
  providers: [CommissionRulesService, CommissionAccrualService, CommissionAccrualsQueryService, CommissionAdjustmentService],
  exports: [CommissionAccrualService, CommissionAdjustmentService],
})
