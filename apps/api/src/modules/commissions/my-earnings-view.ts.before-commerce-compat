...
export const myEarningsInclude = {
  ...
  transactionLineItem: { select: { serviceId: true, serviceNameSnapshot: true } },
} satisfies Prisma.CommissionAccrualInclude;

type CommissionAccrualWithContext = Prisma.CommissionAccrualGetPayload<{ include: typeof myEarningsInclude }>;
...
export function toMyEarningsLineView(accrual: CommissionAccrualWithContext): MyEarningsLineView {
  return {
