...
Refunds, reversals, payouts, cash-session reconciliation, and any "paid"/settlement status for a commission remain explicitly out of scope for this stage (docs/ROADMAP.md Phase 9).
